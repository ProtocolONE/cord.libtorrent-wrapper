...
componentName = "LibtorrentWrapper"
...
#    version = "1.0"
    ...
    requires = "Qt/5.5.1@common/stable", "Libtorrent/1.0.5@common/stable"
    build_requires = "Qt/5.5.1@common/stable", "Libtorrent/1.0.5@common/stable"
...
<Project xmlns="http://schemas.microsoft.com/developer/msbuild/2003">
  <ItemDefinitionGroup>
    ...
    def package(self):
        ...
        self.copy("LibtorrentWrapper*.lib", dst="lib", keep_path=False)
        self.copy("LibtorrentWrapper*.dll", dst="bin", keep_path=False)
        self.copy("LibtorrentWrapper*.dylib*", dst="lib", keep_path=False)
        self.copy("LibtorrentWrapper*.so", dst="lib", keep_path=False)
        self.copy("LibtorrentWrapper*.a", dst="lib", keep_path=False)
